...
% What truly enamours me about a mathematical theorem is surprising reductions to facts that come from completely different disciplines.
...
% TODO INSERT REU-specific Blurb
% SUMRY project - Extremal problems in discrete geometry
% Talk about having read diestel, motivations.

% why im apply to ... project: to do a field that is near and dear to my heart with others.
...
% As I learned more and more mathematics, I found myself constantly using what I learned to expand my knowledge of Graph Theory. As I learned linear algebra, I became acquanted with edge and vertex spaces and the use of the adjacency matrix. As I learned about Laplace's equation, I found out about the graph laplacian. As I learnt probablity theory, so too did I learn about the use of the probabilistic method in


% What I love about graph theory is it practically forces you to do mathematics in a way that I find appealing; the core concepts are so barebones that you have to constantly reach outside of the subject itself for techniques. Whether it be the probabilistic methods
%
